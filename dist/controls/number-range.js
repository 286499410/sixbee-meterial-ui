        ...
        value: function setValue(value) {
            ...
            if (this.props.onChange) {
                if (this.isEmpty(startDate) && this.isEmpty(endDate)) {
                    ...
                    this.props.onChange([!this.isEmpty(startDate) ? _utils2.default.strToTime(startDate) : undefined, !this.isEmpty(endDate) ? _utils2.default.strToTime(endDate) : undefined], this);
                } else {
