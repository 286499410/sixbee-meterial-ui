...
var Pager = function (_Component) {
    ...
    (0, _createClass3.default)(Pager, [{
        ...
        value: function render() {
            ...
            var props = (0, _assign2.default)({}, _.isFunction(Table.props.pager) ? Table.props.pager(Table) : Table.props.pager);
            return _react2.default.createElement(
                'div',
                { className: 'table-pager clearfix ' + (Table.props.bordered ? 'bordered' : '') },
