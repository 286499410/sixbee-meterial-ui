...
var nav = function (_Component) {
    ...
    function nav(props) {
        ...
        _this.renderNavItem = function (item) {
            ...
            var key = item.key || item.dataKey;
            if (App.lib('object').isArray(item.children) && item.children.length > 0) {
                var children = [],
                    selected = void 0;
        ...
        if (props.selectedKey) {
            _this.state.selectedKey = props.selectedKey.replace(App.request.getRoot(), '');
        }
        if (props.dataSource) {
        ...
        value: function render() {
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(_icon2.default, { className: this.props.icon }),
                    _react2.default.createElement(
                        'span',
                        { className: 'label' },
                        this.props.label
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        'div',
                        { className: 'pop-arrow' },
                        _react2.default.createElement('img', { src: '/image/pop-arrow.png' })
                    ),
                    _react2.default.createElement(
                        'ul',
    ...
    (0, _createClass3.default)(NavItem, [{
        ...
        value: function render() {
            ...
            if (this.props.selected) {
                className += ' ' + (this.props.parentKey == 0 ? 'as-selected' : 'selected');
            }
            return _react2.default.createElement(
                'li',
                { className: className, 'data-key': this.props.itemKey,
                    'auth-key': this.props.itemKey },
                _react2.default.createElement(
                    'label',
